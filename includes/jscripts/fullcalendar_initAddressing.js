$(document).ready(function() {
    ...
    var calendarScheduling=calendarScheduleAddressing;
    ...
    var currentJobID=0;
        $('#calendar').fullCalendar({
            ...
            allDaySlot: false,
            firstHour: calendarStartAddressing,
            slotMinutes: calendarAddressingSlots,
            header: {
            ...
            events: "includes/ajax_handlers/fetchCalendarAddressing.php",
            
            eventDrop: function(event,dayDelta,minuteDelta,revertFunc) {
                $.ajax({
                   url: 'includes/ajax_handlers/updateCalendarAddressing.php',
                   type: "POST",
            ...
            dblclick: function(event, jsEvent, view) {
                ...
                */
                window.open('addressingJobs.php?popup=true&action=edit&id='+event.id,'Bindery Job Editor',"scrollbars=0, resizeable=1, width=940, height=850");
            },
                        ...
                        .dialog({
                            ...
                            buttons: {
                               ...
                               success: function(res) {
                                   ...
                                   if(res[0]=='success')
                                   {
                                      window.open('addressingJobs.php?popup=true&action=edit&id='+res[1],'Addressing Job Editor',"scrollbars=0, resizeable=1, width=940, height=850");
                ...
                element.contextMenu('jobCmenu',{
                    'Print Job Ticket': {
                        click: function(element){ // element is the jquery obj clicked on when context menu launched
                            window.open('addressingJobs.php?action=print&jobid='+event.id,'Addressing Job Ticket',"scrollbars=0, resizeable=1, width=750, height=640");
                        }
                    },
                    'Edit Job': {
                        click: function(element){ // element is the jquery obj clicked on when context menu launched
                            window.open('addressingJobs.php?popup=true&action=edit&id='+event.id,'Addressing Job Editor',"scrollbars=0, resizeable=1, width=900, height=850");
                        }
                    },
                    'Delete Job': {
                       click: function(element){ // element is the jquery obj clicked on when context menu launched
